...
### 2.1 store.ts (35 行) - 轻量级 Redux-like 状态容器
...
### 2.2 AppStateStore.ts (570 行) - 160+ 字段的 AppState 类型定义
...
### 2.3 onChangeAppState.ts (172 行) - 状态变更副作用处理
...
### 2.5 teammateViewHelpers.ts (142 行) - 队友视图切换辅助函数
...
### 2.6 AppState.tsx (200 行) - React 上下文与 Hooks 集成层
