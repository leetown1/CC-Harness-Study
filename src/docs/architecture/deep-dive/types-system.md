...
> **核心文件**: permissions.ts (402 行), plugin.ts (354 行), command.ts (199 行), hooks.ts (272 行)

---

## 1. permissions.ts - 权限类型系统 (402 行)
...
## 7. textInputTypes.ts - 文本输入类型系统 (340 行)
